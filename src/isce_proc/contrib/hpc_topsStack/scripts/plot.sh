...
plot_imgs.py -i 'ion_azshift_dates/*.ion' --redo --loc 1 --chan 1 --out pic/img_azshiftDate --wrap 0.00628 --amp
plot_imgs.py -i 'ion_burst_ramp_merged_dates/*.float' --redo --loc -1 --chan 1 --out pic/img_ionRampDate --wrap 0.0628 --amp
